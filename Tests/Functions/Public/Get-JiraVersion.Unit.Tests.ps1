...
"@
        ...
        Mock Get-JiraProject -ModuleName JiraPS {
            ...
            $json | Where-Object { $_.Key -in $Project } | ForEach-Object {
                [PSCustomObject]@{
    ...
    Describe "Behavior" {
        ...
        It "gets a Version using the pipeline from another Version" {
            $version1 = Get-TestJiraVersion -ID $versionID2 -JiraServer $jiraServer
            $version2 = Get-TestJiraVersion -ID $versionID2 -JiraServer $jiraServer
        ...
        It "gets all Versions using Project as pipe input" {
            $results = Get-TestJiraProject -Key $projectKey -Id $projectId -JiraServer $jiraServer | Get-JiraVersion
            ...
            # Get-JiraVersion calls Get-JiraProject internally to resolve the project object.
            Should -Invoke Get-JiraProject -ModuleName JiraPS -Exactly 1
