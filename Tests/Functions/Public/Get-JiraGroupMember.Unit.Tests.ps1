...
'@
    ...
    Describe "Input Validation" {
        ...
        It "Accepts a group object for the -InputObject parameter" {
            $group = Get-TestJiraGroup -Name 'testgroup' -JiraServer $jiraServer
            ...
            # Get-JiraGroup is called once by Get-JiraGroupMember to resolve the group object.
            Should -Invoke Get-JiraGroup -ModuleName JiraPS -Exactly 1
        }
    }
}
