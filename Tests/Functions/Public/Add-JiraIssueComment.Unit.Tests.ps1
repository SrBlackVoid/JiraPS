...
"@
        ...
        Mock Get-JiraIssue -ModuleName JiraPS {
            ...
            Get-TestJiraIssue -ID $issueID -Key $issueKey -JiraServer $jiraServer
        }
    ...
    Describe "Behavior" {
        ...
        It "returns a Jira.Comment object" {
            ...
            Should -Invoke 'ConvertTo-JiraComment' -ModuleName JiraPS
        }
    }
    ...
    Describe "Input Validation" {
        Context "Type Validation - Positive Cases" {
            It "Accepts pipeline input from Get-JiraIssue" {
                $commentResult = Get-TestJiraIssue -Key $IssueKey | Add-JiraIssueComment -Comment 'This is a test comment from Pester, using the pipeline!'
